...
export async function resourceItemCopy({apiKey, baseURL, resourceName, itemID, newName, folderPath}) {

    const response = await fetch(`${baseURL}/rest-api/v1.2/resources/${resourceName}/items/${itemID}/copy?newName=${newName}&folderPath=${folderPath}`, {
        method: "POST",
        headers: {
            "api-key": apiKey
        }
